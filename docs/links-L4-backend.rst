=========================
Setting up the L4 Backend
=========================

.. grid:: 2

    .. grid-item-card:: Backend Setup Instructions
        :link: links-backend-setup-instructions
        :link-type: doc

        Instructions for the setup of the necessary tools.

    .. grid-item-card:: A Conceptual Explanation of the L4 Backend
        :link: pdpa-dbno-explanations
        :link-type: doc
...
- Users looking to install the entire L4 stack on their servers should go to the "Backend Setup Instructions".

- Users looking to understandd how the L4 backend works to adapt it to their needs should read the "Conceptual Explanation".
